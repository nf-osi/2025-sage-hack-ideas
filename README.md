...
| [idea: Integrated Project Triage Dashboard: Jira + Synapse + GitHub](https://github.com/nf-osi/2025-sage-hack-ideas/issues/25) | Created with AI assistance from Claude Prompt: Draft a new issue with the same format. For this new... |
...
| [idea: Synapse study summary report for funders and contributors](https://github.com/nf-osi/2025-sage-hack-ideas/issues/31) | Create a tool / interface that generates a funder-friendly study summary report for a Synapse... |
<!-- IDEAS_TABLE_END -->
